...
void CrossSection::nuTest(TString file, TString name)
{
    ...
    TH2F *h2 = new TH2F("Test","Test",100,-70,0,800,0,800);
...
int main()
{
    ...
    sc->nuTest("data/Pomiar1/zrodlo_lewo25_1_1.txt", "test01");
    sc->nuTest("data/Pomiar1/zrodlo_lewo25_1_2.txt", "test02");
    sc->nuTest("data/Pomiar1/zrodlo_lewo25_1_3.txt", "test03");
   // sc->nuTest("data/Pomiar1/zrodlo_prawo5_1_1.txt", "test01");
  //  sc->nuTest("data/Pomiar1/zrodlo_prawo5_1_2.txt", "test02");
//    sc->nuTest("data/Pomiar1/zrodlo_prawo5_1_3.txt", "test03");
