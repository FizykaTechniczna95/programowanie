...
class CrossSection : public TObject {
    public:
        CrossSection(){
            fFile = new TFile("output/nuCrossSection_atom.root", "RECREATE");
        }
        ~CrossSection(){}
...
void CrossSection::nuTest(TString file, TString name)
{
    ...
    TH2F *h2 = new TH2F("Test","Test",100,-60,0,800,0,600);
...
//    sc->nuTest("data/fiztech2/Pomiar1/zrodlo_sr_1_new1.txt", "test01");
//    sc->nuTest("data/fiztech2/Pomiar1/zrodlo_sr_1_new2.txt", "test02");
    sc->nuTest("zrodlo_lewo15_1.txt", "test1"); 
    sc->nuTest("zrodlo_lewo15_2.txt", "test2");
    sc->nuTest("zrodlo_lewo15_3.txt", "test3");
    sc->nuPrint();
}
