...
class CrossSection : public TObject {
    public:
        CrossSection(){
            fFile = new TFile("nuCrossSection.root", "RECREATE");
        }
        ~CrossSection(){}
...
void CrossSection::nuTest(TString file, TString name)
{
    ...
    TH2F *h2 = new TH2F("Test","Test",100,-70,0,1500,0,600);
...
int main()
{
    ...
    sc->nuTest("zrodlo_lewo5_1_1.txt", "test01");
    sc->nuTest("zrodlo_lewo5_1_2.txt", "test02");
