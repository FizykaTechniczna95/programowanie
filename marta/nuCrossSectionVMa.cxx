...
void CrossSection::nuTest(TString file, TString name)
{
    ...
    TH2F *h2 = new TH2F("Test","Test",100,-90,20,800,0,800);
...
int main()
{
    ...
    sc->nuTest("zrodlo_prawo25_1_1.txt", "hist1");
    sc->nuTest("zrodlo_prawo25_1_2.txt", "hist2");
    //sc->nuTest("zrodlo_prawo25_1_3.txt", "hist3");
    sc->nuPrint();
}
